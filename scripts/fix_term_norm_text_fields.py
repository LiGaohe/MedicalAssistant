...
def main():
    # 修复−术语规范的5个样本
    input_file = r'd:\practice\MedicalAssisstant\data\experiments\results\ablation_no_term_norm_20260531_161309.jsonl'
    output_file = r'd:\practice\MedicalAssisstant\data\experiments\results\ablation_no_term_norm_20260531_161309_fixed.jsonl'
    zero_recall_samples = ["10042927", "10055575", "10078738", "10134898", "10144880"]
    
    print(f"修复−术语规范的 {len(zero_recall_samples)} 个召回率为0的样本:")
