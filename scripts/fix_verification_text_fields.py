...
def main():
    # 修复−后置核查的1个样本
    input_file = r'd:\practice\MedicalAssisstant\data\experiments\results\ablation_no_verification_20260531_165022.jsonl'
    output_file = r'd:\practice\MedicalAssisstant\data\experiments\results\ablation_no_verification_20260531_165022_fixed.jsonl'
    zero_recall_samples = ["10055575"]
    
    print(f"修复−后置核查的 {len(zero_recall_samples)} 个召回率为0的样本:")
